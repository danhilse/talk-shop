    ...
    <footer className="border-t border-border-subtle bg-bg-primary py-16">
      <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {socialLinks.map((social) => (
              <a
                ...
                className="flex h-12 w-12 items-center justify-center rounded-xl border border-border-subtle bg-bg-secondary text-text-secondary transition-all hover:border-shopify hover:text-shopify hover:-translate-y-1 hover:shadow-lg"
        ...
        <div className="mb-12 grid gap-8 border-t border-border-subtle pt-12 text-center md:grid-cols-3 md:text-left">
          <div>
            <h4 className="mb-2 text-sm font-semibold text-text-primary flex items-center gap-2 justify-center md:justify-start">
              Location
            </h4>
          ...
          <div>
            ...
            <p className="text-sm text-text-secondary">
              <a href="mailto:email@example.com" className="hover:text-shopify transition-colors">
                email@example.com
              </a>
            </p>
          </div>
        ...
        <div className="flex flex-col items-center justify-between gap-4 border-t border-border-subtle pt-8 md:flex-row">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-medium text-text-secondary">Talk Shop</span>
          </div>
          <p className="text-xs text-text-tertiary">
            Not affiliated with Shopify Inc.
          </p>
          <div className="flex gap-6">
            <Link href="/" className="text-xs text-text-tertiary hover:text-shopify transition-colors">
              Home
            </Link>
            <Link href="/community" className="text-xs text-text-tertiary hover:text-shopify transition-colors">
              Community
            </Link>
            <Link href="/support" className="text-xs text-text-tertiary hover:text-shopify transition-colors">
              Support
            </Link>
            <a href="#" className="text-xs text-text-tertiary hover:text-shopify transition-colors">
              Privacy
            </a>
            <a href="#" className="text-xs text-text-tertiary hover:text-shopify transition-colors">
              Terms
